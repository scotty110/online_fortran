module online_nn
 ...
 contains
    ...
    subroutine torch_inference(x, x_prev, y_prev, y)
        ...
        call torch_tensor_from_scalar(in_tensors(1), x, torch_kCPU)
        call torch_tensor_from_scalar(in_tensors(2), x_prev, torch_kCPU)
        call torch_tensor_from_scalar(in_tensors(3), y_prev, torch_kCPU)
